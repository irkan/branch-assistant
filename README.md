...
- OpenAI and Sesame API integration for AI responses
...
2. Sesame API key - For text-to-speech

Add these to your `.env` file:

```
REACT_APP_OPENAI_API_KEY=your_openai_api_key_here
REACT_APP_SESAME_API_KEY=your_sesame_api_key_here
```
...
- `/src/components/` - React components
  ...
  - `ApiIntegration.tsx` - OpenAI and Sesame integration
